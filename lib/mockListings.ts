...
export const listings: Listing[] = [
  ...
  },
  {
    ...
    images: [
      "pexels-pixabay-271624_pbdqiv",
      "pexels-heyho-6315808_rnkoc1",
      "pexels-heyho-6121091_hkwksw",
    ],
    price: 280,
    rating: 4.7,
  ...
  },
  {
    ...
    images: [
      "pexels-heyho-5998117_eg46uc",
      "pexels-heyho-6758788_bssrro",
      "pexels-heyho-6908368_h8jha7",
      "pexels-heyho-5997959_hyfnyn",
    ],
    price: 420,
    rating: 4.9,
  ...
  },
  {
    ...
    location: "Miami, FL",
    images: [
      "pexels-pixabay-279614_kggyle",
      "pexels-heyho-6969824_gcivrs",
      "pexels-heyho-5997967_ogepa2",
    ],
    price: 600,
    rating: 4.6,
    distance: "Downtown",
  ...
  },
  {
    ...
    images: [
      "pexels-jvdm-1457841_a0159n",
      "pexels-heyho-6903160_souvoj",
      "pexels-vika-glitter-392079-3315291_m8paho",
      "pexels-donaldtong94-189333_utwhue",
    ],
    price: 550,
    rating: 4.9,
  ...
  },
  {
    ...
    images: [
      "pexels-kseniachernaya-4450337_gvouty",
      "pexels-expect-best-79873-323780_cmnr2u",
      "pexels-fotoaibe-1571468_f8bevr",
    ],
    price: 700,
    rating: 4.8,
  ...
  },
  {
    ...
    location: "Denver, CO",
    images: [
      "pexels-heyho-6585598_u5gdjw",
      "pexels-heyho-6492398_yixqhn",
      "pexels-fotoaibe-1571460_1_z1c6da",
      "pexels-heyho-7512031_iyeslb",
    ],
    price: 380,
    rating: 4.5,
    distance: "Suburb",
  ...
  },
  {
    ...
    images: [
      "pexels-emrecan-2079246_tiwltw",
      "deborah-cortelazzi-gREquCUXQLI-unsplash_znrcag",
      "patrick-perkins-3wylDrjxH-E-unsplash_urhhme",
    ],
    price: 310,
    rating: 4.7,
    distance: "Central",
  ...
  },
  {
    ...
    images: [
      "pexels-heyho-7511695_zfw8tj",
      "frames-for-your-heart-FqqiAvJejto-unsplash_hi4kmn",
      "pexels-heyho-7511693_w5fmn4",
      "jarek-ceborski-jn7uVeCdf6U-unsplash_niprcy",
    ],
    price: 490,
    rating: 4.9,
    distance: "Remote",
  ...
  },
  {
    ...
    location: "Aspen, CO",
    images: [
      "francesca-tosolini-tHkJAMcO3QE-unsplash_qvrfx3",
      "naomi-hebert-MP0bgaS_d1c-unsplash_tcittg",
      "pexels-fotoaibe-1743227_pybani",
    ],
    price: 950,
    rating: 4.8,
  ...
  },
  {
    ...
    location: "Chicago, IL",
images: [
  "pexels-ilya-shakir-1278798-2440471_bdsh3v",
  "pexels-pixabay-279719_zup9l4",
  "Beachfront_jton5v",
  "hosemorocan_s2i3da",
],
    price: 1100,
  ...
  },
  {
    ...
    location: "Boston, MA",
    images: [
      "living-room-930804_1920_omjqsm",
      "bedroom-5772286_1920_sdjwjk",
      "bedroom-5667527_1920_hfdzmc",
    ],
    price: 330,
    rating: 4.8,
  ...
  },
  {
    ...
    location: "Fiji",
    images: [
      "bedroom-5969977_1920_irfvig",
      "bedroom-389254_1280_nasruu",
      "wall-416060_1920_g7qgsl",
      "bedroom-1285156_1920_v8grlx",
    ],
    price: 2500,
    rating: 5.0,
    distance: "Exclusive",
